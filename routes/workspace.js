...
const worksapceController = require('./../controllers/workspace')

router.get("/names", worksapceController.getNames)

// Gets workspaces from user 
router.get('/all', worksapceController.getAll);

router.post('/create', worksapceController.createWorkspace);

router.delete("/:workspaceID/delete",worksapceController.deleteWorkspace);

// Search workspace by name
router.get("/search", worksapceController.search);

router.get("/info", worksapceController.getInformation);
